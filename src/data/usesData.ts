...
export const USES_SECTIONS: UsesSection[] = [
  {
    ...
    items: [
      ...
      {
        name: 'iTerm2',
        description: 'Terminal for macOS that does amazing things',
  ...
  },
  {
    ...
    items: [
      {
        name: 'MacBook Pro',
        description: 'Apple M1 Pro. 16gb RAM',
      ...
      {
        name: 'Keychron K2',
        description: 'My first mechanical keyboard. Gateron brown switches',
        link: 'https://www.keychron.com/products/keychron-k2-wireless-mechanical-keyboard?variant=31063869718617',
      },
    ],
  },
]

export const USES: UsesItem[] = USES_SECTIONS.reduce<UsesItem[]>(
  (all, section) => all.concat(section.items),
  []
)
